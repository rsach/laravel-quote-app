...
<section class="edit-quote">
    ...
    <form method="post" action="{{ route('create')}}">
        <div class ="input-group">
            ...
            <input type="text" name="author" id="author" placeholer="Your Name"/>
        ...
        <div class ="input-group">
            ...
            <input type="text" name="email" id="email" placeholer="Your E-mail"/>
             
             
        </div>
        <div class ="input-group">
            <label for="quote">Your Quote:</label>
            <textarea name="quote" id="quote" rows = "5" placeholer="Your Quote"></textarea>
